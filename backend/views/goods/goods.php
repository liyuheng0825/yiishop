...
<div class="header w1210 bc mt15">
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl cat1 "> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd" style='display:none;'>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$row->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$row->logo?>" alt="" width="320px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$key->path?>',largeimage: '<?=$key->path?>'}"><img src="<?=$key->path?>"></a>
                            </li>
                            <?php endforeach;?>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?=$row->sn?></li>
                    <li class="market_price"><span>定价：</span><em>￥<?=$row->market_price?>/斤</em></li>
                    <li class="shop_price"><span>本店价：</span> <strong>￥<?=$row->shop_price?>/斤</strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?=date('Y-m-d',$row->add_time)?></li>
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="#" id="mya" class_id="<?=$row->id?>">(此商品游览<?=$hits->hits?>人)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
...
<script type="text/javascript">
    ...
    //>>点击数
    $.getJSON('goods-list/hist',{id:$('#mya').attr('class_id')},function (evet) {
        if(evet){
            $('#mya').html('<a href="#" id="mya" class_id="86">(此商品游览'+evet+'人)</a>');
        }
    })
